...
// Firebase database
var database = new Firebase("https://function-communication.firebaseio.com/");
...
function produceOrder() {
  ...
  var sixPlotsOrder = [array1[0], array1[1], array1[2], array2[0], array2[1], array2[2]];
